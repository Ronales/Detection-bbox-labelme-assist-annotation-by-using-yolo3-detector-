...
if __name__ == '__main__':
    ...
    parser.add_argument('--epochs', type=int, default=400)  # 500200 batches at bs 16, 117263 images = 273 epochs
    ...
    parser.add_argument('--weights', type=str, default='weights/backup250.pt', help='initial weights')  # i.e. weights/darknet.53.conv.74
